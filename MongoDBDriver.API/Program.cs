...
using MongoDBDriver.Application.Validators;
using MongoDBDriver.Infrastructure.Configuration;
using MongoDBDriver.Infrastructure.Data;
using MongoDBDriver.Infrastructure.Repositories;
using MongoDBDriver.Infrastructure.Services;
using MongoDBDriver.API.Endpoints;
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "MongoDBDriver Orders API - DDD Demo",
        Version = "v1",
        Description = @"
...
builder.Services.AddMediatR(cfg => {
    cfg.RegisterServicesFromAssembly(typeof(MongoDBDriver.Application.Commands.CreateOrderCommand).Assembly);
});
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "MongoDBDriver Orders API v1");
        c.RoutePrefix = "swagger"; // Swagger UI at /swagger
        c.DocumentTitle = "MongoDBDriver Orders API - DDD Demo";
